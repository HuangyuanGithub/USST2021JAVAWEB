    ...
    <main>
        ...
        <section class="py-3 text-center container" style="background-color: honeydew">
            <div class="row py-lg-3">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">管理员页面：学院管理</h1>
        ...
        <div>
            <table align="center" border="3" cellspacing="0" class="table">
                ...
                <c:forEach var="list" items="${requestScope.collegeList}" varStatus="status">
                <tr align="center">
                    <td>${status.count}</td>
                    <td>${list.name}</td>
                    <td><a href="alterCollege.jsp?id=${list.id}&name=${list.name}">修改</a>&nbsp;
                        <a onclick="javascript:return del()" href="UpdateCollegeServlet?id=${list.id}" style="color: red">删除</a><td>
                </tr>

                </c:forEach>
            </table>
        </div>
        <div align="center"><a href="alterCollege.jsp" class="btn btn-primary" >+新增学院</a></div>
