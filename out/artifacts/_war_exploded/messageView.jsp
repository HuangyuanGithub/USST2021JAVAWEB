        ...
        <table align="center" border="3" cellspacing="0" class="table">
            ...
            <c:forEach var="list" items="${requestScope.messageList}" varStatus="status">
                <tr align="center">
                    ...
                    <td>
                        <c:if test="${sessionScope.status!='teacher'}">
                        <a href="alterMessage.jsp?id=${list.id}&title=${list.title}&text=${list.text}">修改</a></c:if>


                        <a onclick="javascript:return del()" href="UpdateMessageServlet?id=${list.id}"style="color: red">删除</a><td>
                </tr>
