...
@WebServlet(name = "TeacherDeleMessageServlet", value = "/TeacherDeleMessageServlet")
public class TeacherDeleMessageServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            messageList = messageOperation.getTeacherMessage(id);
        } catch (Exception e) {
            e.printStackTrace();
        }
