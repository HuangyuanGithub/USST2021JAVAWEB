    ...
    <div>
        <table align="center" border="3" cellspacing="0" class="table">
            ...
            <tr align="center">
                ...
                <td>${list.detail}</td>
                <td>
                    <form id="form1" action="UpdateTeachTeacherServlet" method="post">
                        <input type="hidden" name="teacherId" value="${list.id}"/>
                        <input type="hidden" name="courseId" value="${requestScope.id}"/>
